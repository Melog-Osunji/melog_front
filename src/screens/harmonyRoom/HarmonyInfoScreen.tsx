...
import { useRequestJoinHarmonyRoom, useLeaveHarmonyRoom, useBookmarkHarmonyRoom } from '@/hooks/queries/harmonyRoom/useHarmonyRoomPost';
...
export default function HarmonyInfoScreen() {
    ...
    const { mutateAsync: requestJoin, isPending: joinLoading } = useRequestJoinHarmonyRoom(roomID);
    const { mutateAsync: leaveRoom, isPending: leaveLoading } = useLeaveHarmonyRoom(roomID);
